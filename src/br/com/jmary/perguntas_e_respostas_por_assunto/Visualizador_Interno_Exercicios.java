 ...
 * @author admin
 */
public class Visualizador_Interno_Exercicios extends javax.swing.JPanel {
     ...
     * @param altura2
     */
    public Visualizador_Interno_Exercicios( Home Home2, JTabbedPane tabAssunto_Recebido2, Class Classe_Das_Imagens2, int img_Atual2, String endereco_Externo_da_Pasta2, int largura2, int altura2 ) {
        initComponents();
        ...
        if( jLabel1.isEnabled() == true ){
            ...
            new Thread() {   @Override public void run() { try { //Thread.sleep( 1000 );
                ...
                if( img_Atual < vxAtual ) {    
                    ...
                    img_Atual++;
                    Home.jp_Letras_das_Respostas_Exercicios.setVisible(true);
                    Home.lb_Reiniciar_Exercicios.setVisible(false);
                    setarImagemInterna(img_Atual);
                }
                else{
                
                    img_Atual++;
                    Home.jp_Letras_das_Respostas_Exercicios.setVisible(false);
                    Home.lb_Reiniciar_Exercicios.setVisible(true);
                }
    ...
    String home_inicio = "";
    String nome_do_arquivo_gerado = "zz_exercicios_html";
    String nome_da_pasta_das_imagens = "zz_exercicios_html_imagens";
    private void jLabel13MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MousePressed
        ...
        */
        ...
        new Thread() {   @Override public void run() { try { //Thread.sleep( 1 );
            ...
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, "Exercícios - " + titulo_do_assunto + " - Espaço reservado para Perguntas e Respostas / Leitura e Aprendizagem - Informática, Português, Matemática, Física, Química, Biologia, Geografia, História, Filosofia..."  );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, "' >" );
...
//  script início   ##########################################################################       
    ...
    Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, "\n\n <script type=\"text/javascript\"> " );
        ...
        //Variáveis globais
        Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, 
            "\n\n  var assuntodoexercicio = '" + nome_do_arquivo_gerado + "'; " +
            "\n var exeatual = 0; " +
            "\n var qtdacertos = 0; " +
            "\n var qtdaerros = 0; " +
    ...
    public void setarImagemInterna( int img_AtualRecebida ){ 
        ...
        /*new Thread() {   @Override public void run() {*/ try { //Thread.sleep( 1 );
                ...
                if( (img_AtualRecebida < qtdArquivos) && (img_AtualRecebida >= 0) ){
                    ...
                    Home.lb_Status_Resposta_Exercicios.setText( "Exercício: " + vAtual + " de: " + qtdArquivos );
