 ...
 * @author admin
 */
public class Visualizador_Interno_Expert extends javax.swing.JPanel {
     ...
     * @param altura2
     */
    public Visualizador_Interno_Expert( Home Home2, JTabbedPane tabAssunto_Recebido2, Class Classe_Das_Imagens2, int img_Atual2, String endereco_Externo_da_Pasta2, int largura2, int altura2 ) {
        initComponents();
        ...
        if( jLabel1.isEnabled() == true ){
            ...
            new Thread() {   @Override public void run() { try { //Thread.sleep( 1000 );
                ...
                if( img_Atual < vxAtual ) {    
                    ...
                    img_Atual++;
                    Home.jp_Letras_das_Respostas_Expert.setVisible(true);
                    Home.lb_Reiniciar_Expert.setVisible(false);
                    setarImagemInterna(img_Atual);
                }
                else{
                
                    img_Atual++;
                    Home.jp_Letras_das_Respostas_Expert.setVisible(false);
                    Home.lb_Reiniciar_Expert.setVisible(true);
                }
    ...
    String home_inicio = "";
    String nome_do_arquivo_gerado = "zz_expert_html";
    String nome_da_pasta_das_imagens = "zz_expert_html_imagens";
    private void jLabel13MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MousePressed
        ...
        */
        ...
        new Thread() {   @Override public void run() { try { //Thread.sleep( 1 );
            ...
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, "Expert - " + titulo_do_assunto + " - Espaço reservado para Perguntas e Respostas / Leitura e Aprendizagem - Informática, Português, Matemática, Física, Química, Biologia, Geografia, História, Filosofia..."  );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, "' >" );
        ...
        try { 
            ...
            while( ( ze = zip.getNextEntry() ) != null ) {
                ...
                if( nomeList[0].trim().equalsIgnoreCase( nome_do_pacote_endereco_Iterno_Do_Assunto ) ){
                    ...
                    try{
                        if( nomeList[1].trim().equalsIgnoreCase("Expert") ){
    ...
    public void setarImagemInterna( int img_AtualRecebida ){ 
        ...
        /*new Thread() {   @Override public void run() {*/ try { //Thread.sleep( 1 );
                ...
                if( (img_AtualRecebida < qtdArquivos) && (img_AtualRecebida >= 0) ){
                    ...
                    Home.lb_Status_Resposta_Expert.setText( "Expert: " + vAtual + " de: " + qtdArquivos );
                    ...
                    try{ Home.resposta_correta_do_expert_atual = nomeList2[1]; } catch (Exception ex) {} //System.out.println("\n\n 333 - Home.resposta_correta_do_exercicio_atual - " + Home.resposta_correta_do_exercicio_atual);  
