...
import br.com.jmary.perguntas_e_respostas_por_assunto.imagens_internas.Imagens_Internas;
 ...
 */
public class Adicionar_Assunto_Html_Ao_JEditorPane {
    ...
    String nome_do_arquivo_gerado = "zz_assunto_html_tab_interno";
    String nome_da_pasta_das_imagens = "zz_assunto_html_tab_interno_imagens";
    
    int contador = 1;
   
    public Adicionar_Assunto_Html_Ao_JEditorPane( int contador2, JTabbedPane tabAssunto_Recebido2, Class Classe_Das_Imagens2, int img_Atual2, String nome_do_pacote_endereco_Iterno_Do_Assunto2, int largura, int altura ) {                            
        ...
        /*new Thread() {   @Override public void run() {*/ try { //Thread.sleep( 1 );
            ...
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, nome_do_pacote_endereco_Iterno_Do_Assunto );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo_html, "</title>" );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
                BufferedImage bufImg = null;
                    ...
                    Image         image  = null;
                    try{
                        bufImg = ImageIO.read(Classe_Das_Imagens2.getResource( listaDosArquivos.get( i ) ) );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                
            ...
            new Thread() {   @Override public void run() { try { //Thread.sleep( 1 );
                ...
                if( contador < 5 ){
                    ...
                    Adicionar_Assunto_Html_Ao_JEditorPane ADD = new Adicionar_Assunto_Html_Ao_JEditorPane( novo_contador, tabAssunto_Recebido, Classe_Das_Imagens, img_Atual, nome_do_pacote_endereco_Iterno_Do_Assunto, 0, 0 );
